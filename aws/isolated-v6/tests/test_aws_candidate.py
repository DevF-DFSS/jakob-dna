...
negative('unqualified_invoke',lambda r:r['FunctionResourcePolicy']['Properties']['PolicyDocument']['Statement'][-2].update(Resource={'Fn::GetAtt':['Function','Arn']}))
negative('public_principal',lambda r:r['FunctionResourcePolicy']['Properties']['PolicyDocument']['Statement'][-2].update(Principal='*'))
negative('broad_source',lambda r:r['FunctionResourcePolicy']['Properties']['PolicyDocument']['Statement'][-2]['Condition']['ArnLike'].update({'aws:SourceArn':'*'}))
...
negative('missing_source_account',lambda r:r['FunctionResourcePolicy']['Properties']['PolicyDocument']['Statement'][-2]['Condition']['StringEquals'].pop('aws:SourceAccount'))
